module github.com/xiaoshicae/x-one/xgorm/clickhouse
...
require (
	...
	github.com/xiaoshicae/x-one/xmetric v0.0.0 // indirect
	github.com/xiaoshicae/x-one/xtrace v0.0.0 // indirect
